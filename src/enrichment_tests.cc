...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void EnrichmentTest::TearDown() { delete src_facility; }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Material::Ptr EnrichmentTest::DoOffer(cyclus::Material::Ptr mat) {
  return src_facility->Offer_(mat);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Material::Ptr EnrichmentTest::DoEnrich(cyclus::Material::Ptr mat,
                                               double qty) {
